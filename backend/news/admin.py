...
class NewsAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Contenu", {"fields": ("title", "content", "category", "importance")}),
        ("Médias", {"fields": ("image", "attachment"), "classes": ("collapse",)}),
        (
            "Ciblage",
            {
        ...
        ("Publication", {"fields": ("status", "publish_date", "expiry_date")}),
        (
            "Modération",
            {
...
class NotificationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Contenu", {"fields": ("title", "message", "user", "news")}),
        ("Configuration", {"fields": ("notification_type", "status")}),
        (
            "Horodatage",
            {"fields": ("sent_at", "read_at", "created_at"), "classes": ("collapse",)},
        ),
    )
