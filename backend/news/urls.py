...
urlpatterns = [
    ...
    # Modération
    path('moderation/pending/', views.PendingNewsListView.as_view(), name='pending-news'),
    path('moderation/news/<int:news_id>/', views.moderate_news, name='moderate-news'),
    path('moderation/stats/', views.ModerationStatsView.as_view(), name='moderation-stats'),
    ...
    path('auth/register-extended/', views.UserExtendedRegistrationView.as_view(), name='register-extended'),
    path('auth/profile-extended/', views.UserExtendedProfileView.as_view(), name='profile-extended'),
    ...
    path('organisation/stats/', views.OrganisationStatsView.as_view(), name='organisation-stats'),
]