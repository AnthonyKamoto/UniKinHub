...
const CreateNewsPage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Créer l'actualité via l'API
            const createdNews = await newsAPI.createNews(formDataToSend)
            console.log("=== ACTUALITÉ CRÉÉE ===", createdNews)
                    ...
                    <Grid container spacing={3}>
                        <Grid item xs={12}>
                            <TextField
                                ...
                                helperText={
                                    errors.summary || "Maximum 200 caractères"
                                }
                                multiline
                                rows={3}
                                required
                    ...
                    <Grid container spacing={3}>
                        <Grid item xs={12}>
                            ...
                            <Typography
                                ...
                                sx={{ mt: 1 }}
                            >
                                Les brouillons ne sont pas publiés et peuvent
                ...
                return (
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                {formData.content ||
                                    "Contenu détaillé de l'actualité"}
                            </Typography>
                        ...
                        {formData.draft && (
                            <Alert severity="warning" sx={{ mt: 2 }}>
                                Cette actualité sera enregistrée comme brouillon
                                et ne sera pas publiée
                            </Alert>
                        )}
                    </Paper>
                )
