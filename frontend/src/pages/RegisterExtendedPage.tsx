        ...
        <ListItem disablePadding sx={{ py: 0.25 }}>
          ...
          <ListItemText
            ...
            primaryTypographyProps={{
              variant: 'caption',
              color: criteria.minLength ? 'success.main' : 'text.secondary',
            }}
          />
        </ListItem>
        <ListItem disablePadding sx={{ py: 0.25 }}>
          ...
          <ListItemText
            ...
            primaryTypographyProps={{
              variant: 'caption',
              color: criteria.hasUpperCase ? 'success.main' : 'text.secondary',
            }}
          />
        </ListItem>
        <ListItem disablePadding sx={{ py: 0.25 }}>
          ...
          <ListItemText
            ...
            primaryTypographyProps={{
              variant: 'caption',
              color: criteria.hasLowerCase ? 'success.main' : 'text.secondary',
            }}
          />
        </ListItem>
        <ListItem disablePadding sx={{ py: 0.25 }}>
          ...
          <ListItemText
            ...
            primaryTypographyProps={{
              variant: 'caption',
              color: criteria.hasNumber ? 'success.main' : 'text.secondary',
            }}
          />
        </ListItem>
        <ListItem disablePadding sx={{ py: 0.25 }}>
          ...
          <CardContent sx={{ p: 4 }}>
                  ...
                  <Box component="ul" sx={{ mt: 1, mb: 0 }}>
                    {Object.entries(errors).map(
                      ([field, err]: [string, any]) => (
                        <li key={field}>
                          <strong>{field}</strong>: {err?.message}
                        </li>
                      )
                    )}
                  </Box>
            ...
            <form onSubmit={handleSubmit(onSubmit, onInvalid)}>
                  ...
                  <Grid container spacing={3}>
                    ...
                    <Grid item xs={12}>
                      <Divider sx={{ my: 2 }}>
                        <Typography variant="body2" color="text.secondary">
                          Organisation universitaire (optionnel)
                        </Typography>
                      </Divider>
                    </Grid>
                    ...
                    <Grid item xs={12}>
                      <Controller
                        ...
                        render={({ field }) => (
                          <OrganisationSelector
                            universite={field.value || null}
                            faculte={watchedValues[1] || null}
                            departement={watchedValues[2] || null}
                            onUniversiteChange={(universiteId) => {
                              setValue('universite', universiteId || undefined)
                              setValue('faculte', undefined)
                              setValue('departement', undefined)
                            }}
                            onFaculteChange={(faculteId) => {
                              setValue('faculte', faculteId || undefined)
                              setValue('departement', undefined)
                            }}
                            onDepartementChange={(departementId) => {
                              setValue(
                                'departement',
              ...
              <TabPanel value={tabValue} index={2}>
                <Grid container spacing={2}>
                  <Grid item xs={12} sm={6}>
                    <FormControl fullWidth error={!!errors.promotion}>
                      ...
                      >
                        ...
                        <MenuItem value="L1">L1 (Licence 1ère année)</MenuItem>
                        <MenuItem value="L2">L2 (Licence 2ème année)</MenuItem>
                        <MenuItem value="L3">L3 (Licence 3ème année)</MenuItem>
                        <MenuItem value="M1">M1 (Master 1ère année)</MenuItem>
                        <MenuItem value="M2">M2 (Master 2ème année)</MenuItem>
