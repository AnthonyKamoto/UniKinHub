    ...
    <Box sx={{ minHeight: "100vh", backgroundColor: "#F8FAFC" }}>
        ...
        <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
          <Grid container spacing={4} alignItems="center">
            <Grid item xs={12} md={6}>
              ...
              >
                La plateforme moderne qui connecte les étudiants aux actualités
                de leur université
              </Typography>
              ...
              >
                Restez informé des dernières nouvelles, événements et annonces
                importantes de votre campus en temps réel.
              </Typography>
      ...
      <Box sx={{ py: 10, backgroundColor: "#fafafa" }}>
        <Container maxWidth="lg">
          <Box sx={{ textAlign: "center", mb: 8 }}>
            ...
            >
              Découvrez les outils qui rendent notre plateforme unique
            </Typography>
          </Box>
      ...
      >
        <Container maxWidth="md">
          ...
          >
            Rejoignez notre communauté d'étudiants et restez toujours informé
