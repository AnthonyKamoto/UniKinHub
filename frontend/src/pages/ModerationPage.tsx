...
const ModerationPage = () => {
  ...
  const moderateMutation = useMutation({
    ...
    onSuccess: (data) => {
      const message =
        data.status === "published" ? "Article approuvé" : "Article rejeté";
    ...
    <Box sx={{ p: 3, maxWidth: 1000, mx: "auto" }}>
      ...
      <Box sx={{ mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary">
          Examinez cet article et décidez de son approbation ou de son rejet
        </Typography>
      </Box>
      ...
      <Grid container spacing={3}>
                  ...
                  >
                    ...
                    <Box>
                      ...
                      <Typography variant="caption" color="text.secondary">
                        {article.author.role} - {article.author.university}
                      </Typography>
                    </Box>
                  </Box>
        ...
        <Grid item xs={12} md={4}>
          <Paper sx={{ p: 3, position: "sticky", top: 20 }}>
            ...
            <Alert severity="info" sx={{ mb: 3 }} icon={<History />}>
            ...
            <Box sx={{ mt: 4 }}>
              ...
              <Stack spacing={1}>
                ...
                >
                  ...
                  <Chip label={article.author.role} size="small" />
                </Box>
                <Box
                  sx={{
                    display: "flex",
                ...
                >
                  ...
                  <Typography variant="body2">
                    {format(new Date(article.author.date_joined), "MMMM yyyy", {
                      locale: fr,
                    })}
                  </Typography>
                </Box>
      ...
      >
        ...
        <DialogContent>
          <Typography variant="body2" color="text.secondary" paragraph>
            Veuillez expliquer la raison du rejet. Cette information sera
            communiquée à l'auteur.
          </Typography>
